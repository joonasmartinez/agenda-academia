...
export const Horarios = () => {
    ...
    return (
        <>
           <C.Organize>{horas.map(item => <C.horas key={item.hora}>{item.hora}<C.agendamentos>3</C.agendamentos></C.horas> )}</C.Organize>
        </>
